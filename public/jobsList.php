...
function ciniki_services_jobsList($ciniki) {
	...
	if( isset($args['assigned_id']) ) {
		$strsql .= "LEFT JOIN ciniki_service_job_users ON (ciniki_service_jobs.id = ciniki_service_job_users.job_id "
			. "AND ciniki_service_job_users.user_id = '" . ciniki_core_dbQuote($ciniki, $args['assigned_id']) . "' "
	...
	if( isset($args['type']) && $args['type'] == 'pastdue' ) {
		...
		$strsql .= "AND ciniki_service_job_users.user_id = '" . ciniki_core_dbQuote($ciniki, $args['assigned_id']) . "' ";
